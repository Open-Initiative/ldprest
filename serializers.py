...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    release_set = LDPField(many=True, required=False, prefix="http://%s/release/ldpcontainer/"%settings.LDP_DOMAIN, fields=["name", "done"])
    target = LDPField(read_only=False, model=Release, required=False, prefix="http://%s/release/ldpcontainer/"%settings.LDP_DOMAIN, fields=["name"])
    author = LDPField(required=False, prefix="http://%s/user/ldpcontainer/"%settings.LDP_DOMAIN)
